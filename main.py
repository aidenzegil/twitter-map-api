...
async def root():
    id = 1721070150
    res = twitter_client.get_user(id)
    return res
...
async def root():
    id = 1553081717132611585
    res = twitter_client.get_liking_users(id)
    return res
...
async def root():
    id = 1721070150
    res = twitter_client.get_liked_tweets(id)
    return res
...
async def root():
    id = 1721070150
    res = twitter_client.get_users_following(id)
    return res
